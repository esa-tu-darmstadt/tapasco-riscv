...
//
// On Thu Sep 10 09:17:47 CEST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkRVController(CLK,
  ...
  // inputs to muxes for submodule ports
  assign MUX_state$write_1__SEL_3 = WILL_FIRE_RL_graceDown && grace == 7'd0 ;
  ...
  // register state
  always@(WILL_FIRE_RL_handle_start or
	  state or
	  MUX_state$write_1__SEL_3 or
	  WILL_FIRE_RL_startGracePeriod or WILL_FIRE_RL_endReset)
  case (1'b1)
    WILL_FIRE_RL_handle_start: state$D_IN = 3'd1;
    state == 3'd4: state$D_IN = 3'd0;
    MUX_state$write_1__SEL_3: state$D_IN = 3'd4;
  ...
  endcase
  assign state$EN =
	     WILL_FIRE_RL_graceDown && grace == 7'd0 || state == 3'd4 ||
	     WILL_FIRE_RL_handle_start ||
	     WILL_FIRE_RL_endReset ||
	     WILL_FIRE_RL_startGracePeriod ;
  ...
  assign stdin_base$EN = WILL_FIRE_RL_writeStdinBase || state == 3'd4 ;

  // register stdin_size
  assign stdin_size$D_IN =
	     WILL_FIRE_RL_writeStdinSize ? wr_s_in$D_OUT[38:7] : 32'd0 ;
  assign stdin_size$EN = WILL_FIRE_RL_writeStdinSize || state == 3'd4 ;

  // register stdout_base
  assign stdout_base$D_IN =
	     WILL_FIRE_RL_writeStdoutBase ? wr_s_in$D_OUT[38:7] : 32'd0 ;
  assign stdout_base$EN = WILL_FIRE_RL_writeStdoutBase || state == 3'd4 ;

  // register stdout_size
  assign stdout_size$D_IN =
	     WILL_FIRE_RL_writeStdoutSize ? wr_s_in$D_OUT[38:7] : 32'd0 ;
  assign stdout_size$EN = WILL_FIRE_RL_writeStdoutSize || state == 3'd4 ;
